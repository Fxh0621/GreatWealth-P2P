      ...
      <div style="width: 80%;height: 400px;background-color: white;margin-left: auto;margin-right: auto;position: relative;top: 25px;">
        <div class="layui-row">
            <div class="layui-col-md8">
              ...
              <div class="layui-row">
                <div class="layui-col-md5" style="text-align:center;">
                   ...
                   <p style="font-size: 45px;font-weight: bolder;color: orange;margin-top: 50px;">9.5%</p>
                </div>
                ...
                <div class="layui-col-md3">
                   ...
                   <p style="font-size: 45px;font-weight: bolder;margin-top: 50px;">12 <span style="font-size: 20px;color: gray;">个月</span></p>
                </div>
              </div>
            ...
            <div class="layui-col-md4" style="background-color: #FAFAFA; height: 400px;">
                <form action="/insertInvestTwelveMonth">
                    ...
                    <div>
                        ...
                        <p style="margin-left: 80px;margin-top: 30px;">按利息复投方式预期可赚取<span style="color: orange;font-size: 18px;">198.50</span>元 <span><img src="../image/问号.png" alt="" style="width: 18px;height: 18px;"></span></p>
                        ...
                        <p style="color: green;font-size: 16px;margin-top: 20px;margin-left: 145px;">${sessionScope.investSuccess12}</p>
                        <p style="color: red;font-size: 16px;margin-top: 20px;margin-left: 145px;">${sessionScope.investfail12}</p>

                        <%
                            session.removeAttribute("investSuccess12");
                            session.removeAttribute("investfail12");
                        %>
              ...
              <div class="layui-tab-item layui-show">
                <ul class="layui-timeline">
                    ...
                    <li class="layui-timeline-item">
                      ...
                      <div class="layui-timeline-content layui-text">
                        <div class="layui-timeline-title">12个月后开始收益</div>
                      </div>
                    </li>
                  </ul>
              </div>
        ...
        $.ajax({
            ...
            success:function (data) {
                for (i in data){
                    ...
                    $("#investMonth12").append('<tr>'+tr1+'</tr>')
                    console.log("tr:"+tr1)
                }
            }
