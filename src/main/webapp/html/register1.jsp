            ...
            <div class="layui-col-md5" style="height: 60px;">
                <ul class="layui-nav" style="background-color: white;">
                    ...
                    <c:if test="${sessionScope.user==null}">
                        <li class="layui-nav-item layui-this"><a href="register1.jsp" style="color: skyblue;">免费注册</a></li>
       ...
       <div class="layui-container" style="height: 650px;margin-bottom: 20px;background-color: white;">
        ...
        <div class="layui-row">
           <div class="layui-col-md6">
            <form action="/register" id="registerForm" style="margin-left: 50px;margin-top: 100px;" method="post">
                <table>
                    <tr>
                        <td style="width: 100px;text-align: center;font-size: 20px;font-weight: lighter;">同户名：</td>
                        <td><input type="text" name="username" style="width: 250px;height: 30px;"></td>
                    </tr>
                    <tr>
                        <td><span style="display: inline-block;margin-top: 25px; width: 100px;text-align: center;font-size: 20px;font-weight: lighter;">密码:</span></td>
                        <td><input type="password" name="password" id="password" style="width: 250px;height: 30px;margin-top: 25px;"></td>
                    </tr>
                    <tr>
                        <td><span style="display: inline-block;margin-top: 25px; width: 100px;text-align: center;font-size: 20px;font-weight: lighter;">确认密码:</span></td>
                        <td><input type="password" name="repassword" style="width: 250px;height: 30px;margin-top: 25px;"></td>
                    </tr>
                    <tr>
                        <td><span style="display: inline-block;margin-top: 25px; width: 100px;text-align: center;font-size: 20px;font-weight: lighter;">手机号:</span></td>
                        <td><input type="text" name="phoneNumber" style="width: 250px;height: 30px;margin-top: 25px;"></td>
                    </tr>
                    <tr>
                        <td colspan="2"><span style="display: inline-block;margin-top: 20px;font-size: 15px;"><input type="checkbox" style="display: inline-block;margin-left: 100px;" id="agree">&nbsp;&nbsp;&nbsp;我同意《<span style="color: deepskyblue;">宏量财富注册协议</span>》</span></td>
                    </tr>
                    <tr>
                        <td colspan="2"><input id="bt1" disabled="disabled" type="submit" name="loginNow" value="提交" style="background-color: green;cursor: pointer;width: 160px;height: 50px;display: inline-block;margin-top: 25px;margin-left:120px;color: white;font-weight: bolder;font-size: 21px;"></td>
                    </tr>
                </table>            
            </form>
           </div>
