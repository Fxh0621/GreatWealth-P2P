     ...
     <!-- 左边的选项卡部分 -->
      <div style="width: 25%;height: 80%;background-color: white;float: left;">
         <ul class="left">
             ...
             <li><span style="margin-left: 80px;"><img src="../image/提现.png" alt="" style="width: 30px;height: 30px;"></span><a href="/">提现</a></li>
      ...
      <div style="width: 74%;height: 800px;margin-left: 1%;float: left;background-color: white;">
          ...
          <p style="font-size: 28px;color: black;font-weight: bold;margin-left: 30px;">提现</p>
          <hr>

          <form action="/withdrawView" style="background: url(../image/提现页面.png);background-size: cover;background-repeat: no-repeat;width: 600px;height: 600px;
         margin-left: 180px;margin-top: 80px;">
              <span style="font-size: 25px;font-weight: bolder;color: black;margin-top: 30px;text-align: right;display: inline-block;width: 200px;height: 30px;margin-top: 120px;">提现金额：</span>
              <input type="text" style="width: 300px;height: 35px;margin-top: 120px;" name="withdrawMoney">
              <br>

              <span style="font-size: 25px;font-weight: bolder;color: black;margin-top: 30px;text-align: right;display: inline-block;width: 200px;height: 30px;margin-top: 100px;">请输入您的密码：</span>
              <input type="password" style="width: 300px;height: 35px;margin-top: 100px;" name="password">
              <br>

              <input type="submit" value="确认提现" style="width: 150px;height: 40px;background-color: green;color: white;font-size: 25px;margin-top: 100px;margin-left: 200px;border-radius: 2px;">

              <p style="color: green;font-size: 20px;margin-top: 20px;margin-left: 240px;">${sessionScope.withdrawSuccess}</p>
              <p style="color: red;font-size: 20px;margin-top: 20px;margin-left: 200px;">${sessionScope.withdrawFail}</p>
